    ...
    return BlocBuilder<LatestProductsCubit, LatestProductsState>(
      builder: (context, state) {
        ...
        if (state is LatestProductsLoaded) {
          ...
          return SizedBox(
            height: ResponsiveHelper.getSectionHeight(context, hasSpecialOffer: hasSpecialOffer),
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return Container(
            width: ResponsiveHelper.getHorizontalItemWidth(context),
            margin: EdgeInsetsDirectional.only(
              end: index == 3 ? 0 : ResponsiveHelper.getHorizontalItemMargin(context),
            ),
